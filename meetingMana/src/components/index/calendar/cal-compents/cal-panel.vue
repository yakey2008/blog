<template>
  <div class="cal-wrapper">
    <div class="cal-header">
      <div class="css-todaybtn"><img v-bind:src="todaybg"></div>
      ...
      <div class="css-searchbtn"><img v-bind:src="searchbtn" ></div>
      <div class="css-viewlocation"></div>
    </div>
    <div class="cal-body">
      <div class="weeks">
      ...
      <div class="dates">
        <div v-for="date in dayList" class="item"
          ...
          <p class="date-num"
            ...
            :style="{color: date.title != undefined ? ((date.date == selectedDay) ? colfff:'inherit') : 'inherit'}">
