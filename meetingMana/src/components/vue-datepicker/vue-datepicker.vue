...
<template>
  <div class="cov-vue-date">
    <div class="datepickbox" @click="showCheck($event)" :class="{'css-curregion':showInfo.check}">
      {{formatToWeek(date.time)}}
