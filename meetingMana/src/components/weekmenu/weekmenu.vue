    ...
    <div id="app">
        ...
        <vue-event-calendar :events="demoEvents">
            <template scope="props">
                <div v-for="(event, index) in props.showEvents" class="event-item" :key="event">
...
export default {
    name: 'app',
    mounted() {
        // this.$data.demoEvents = [{
        //     date: `${today.getFullYear()}/${today.getMonth() + 1}/10`,
        //     title: 'Title-1',
    ...
    data() {
        return {
            demoEvents: [{
                date: `${today.getFullYear()}/${today.getMonth() + 1}/7`,
                title: 'Title-1',
                desc: 'longlonglong description'
            }, {
                date: `${today.getFullYear()}/${today.getMonth() + 1}/15`,
                title: 'Title-1212',
                desc: 'longlonglo2321312ng description'
            }, {
